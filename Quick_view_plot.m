...
reward_100 = importdata('/home/ak/Documents/gccProjects/Unicycle/rewards_100.txt');
reward_150 = importdata('/home/ak/Documents/gccProjects/Unicycle/rewards_180.txt');

mean_1 = [mean(reward_1(:,5)),mean(reward_1(:,6)),mean(reward_1(:,7))]
